...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Video, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "video",
	          { className: "center-block", controls: true },
	...
	var bucketUrl = "https://s3.amazonaws.com/umuc.cmsc495.vigilant-video";
	var videos = ["TheOneTheyFear.mp4", "PingPong.mp4", "AvenueQ.webm"];

	var FrontPage = function (_Component2) {
	  _inherits(FrontPage, _Component2);
	  ...
	  function FrontPage() {
	    ...
	    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(FrontPage)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this2), _this2.state = {
	      index: 0
	    }, _this2.incrementVideo = function () {
	      if (_this2.state.index < videos.length - 1) {
	        _this2.setState({ index: _this2.state.index + 1 });
	      }
	    }, _this2.decrementVideo = function () {
	  ...
	  _createClass(FrontPage, [{
	    key: "render",
	    value: function render() {
	      var active_video_url = bucketUrl + "/" + videos[this.state.index];
	      var CurrentVideo = function CurrentVideo() {
	        return _react2.default.createElement(Video, { src: active_video_url });
	      };
	      return _react2.default.createElement(
	        "div",
	        { className: "container" },
	        _react2.default.createElement(
	          "div",
	          { className: "carousel" },
	          _react2.default.createElement(CurrentVideo, null),
	          _react2.default.createElement(
	            "button",
